...
local n: word count $statelist
	...
	*/
	...
	clear
	corp_add_mergers `state' ,dta(`state'.only.dta) merger(/NOBACKUP/scratch/share_scp/ext_data/2018dta/mergers/mergers.dta) storenomatched(`state'.nomatch_new.dta) longstate(`longstate')
