...
forvalues i = 1/`n'{
	...
	post stats ("`state'") ("new_thomson") (`share_matched') (`eshare_matched') (`share') (`count_all') (`count_w_equity') (`tot')
	...
	post stats ("`state'") ("new_zillow") (`share_matched') (`eshare_matched') (`share') (`count_all') (`count_w_equity') (`tot')
	clear
